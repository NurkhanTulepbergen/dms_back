...
class StorePenaltyRequest extends FormRequest
{
    ...
    {
        return [
            'user_id' => 'nullable|integer|exists:users,id|required_without:room_id|prohibits:room_id',
            'room_id' => 'nullable|integer|exists:rooms,id|required_without:user_id|prohibits:user_id',
            'rule_id' => 'required|integer|exists:penalty_rules,id',
            'points' => 'nullable|integer|min:0|max:10',
