...
namespace Modules\BuySell\Providers;
...
class BuySellServiceProvider extends ServiceProvider
{
    use PathNamespace;

    protected string $name = 'BuySell';

    protected string $nameLower = 'buysell';
